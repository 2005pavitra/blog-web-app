...
function Hero() {
  ...
  return (
    <div className="relative overflow-hidden bg-white border-b border-slate-200">
        ...
        <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32 pt-16 sm:pt-24 lg:pt-32 px-4 sm:px-6 lg:px-8">
          <main className="mx-auto max-w-7xl">
            ...
            >
              ...
              {blogCount > 0 && (
                <motion.div 
                  className="mt-4 flex items-center justify-center lg:justify-start gap-2 text-sm font-medium text-slate-600 bg-slate-100 py-1.5 px-4 rounded-full w-fit"
                  variants={itemVariants}
                >
                  <motion.span 
      ...
      >
        <div className="w-full h-64 sm:h-72 md:h-96 lg:h-full relative overflow-hidden bg-gradient-to-br from-amber-100 to-orange-50 flex items-center justify-center">
